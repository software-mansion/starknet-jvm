...
internal class PoseidonTest {
    ...
    fun `poseidon hash many all zeros`() {
        val zeroValue = Felt.ZERO
        val result = Poseidon.poseidonHash(zeroValue, zeroValue, zeroValue)
    ...
    fun `poseidon hash many random values`() {
        val result = Poseidon.poseidonHash(Felt(BigInteger("10")), Felt(BigInteger("8")), Felt(BigInteger("5")))
    ...
    fun `poseidon hash many big numbers`() {
        ...
        val result = Poseidon.poseidonHash(value1, value2, value1)
