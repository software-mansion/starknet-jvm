...
// y^2 = x^3 + Ax + B
@field:JvmField
val A: BigInteger = BigInteger.ONE

@field:JvmField
val B: BigInteger = BigInteger("06f21413efbe40de150e596d72f7a8c5609ad26c15c915c1f4cdfcb99cee9e89", 16)

@field:JvmField
val COFACTOR: BigInteger = BigInteger.ONE

@field:JvmField
val ORDER: BigInteger = BigInteger("800000000000010FFFFFFFFFFFFFFFFB781126DCAE7B2321E66A241ADC64D2F", 16)
...
private fun point(x: String, y: String): ECPoint = CURVE.createPoint(
    BigInteger(x, 16),
    BigInteger(y, 16)
)

@field:JvmField
val GENERATOR_POINT = point(
...
@field:JvmField
val SPEC = ECParameterSpec(CURVE, GENERATOR_POINT, ORDER)

val SAMPLED_GENERATORS: Array<ECPoint> by lazy {
    arrayOf(
        point(
