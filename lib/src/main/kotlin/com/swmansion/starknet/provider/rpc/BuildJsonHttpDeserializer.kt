...
private fun <T> extractResult(jsonRpcResponse: JsonRpcResponse<T>, responsePayload: String, rpcResponsePayload: String = responsePayload): T {
    ...
    if (jsonRpcResponse.result == null) {
        throw RequestFailedException(message = "Response did not contain a result", payload = responsePayload)
    }
